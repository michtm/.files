-- ~/.config/nvim/lua/options.lua - Options pour Neovim
-- Pour la liste des options:
-- - :help option-list
-- - Ou https://neovim.io/doc/user/quickref.html#option-list
...
set.listchars:append({ nbsp = "␣", trail = "•", precedes = "«", extends = "»", tab = "> " })
